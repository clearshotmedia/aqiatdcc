	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'tdcc' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'tdcc' ); ?></th>
			</tr>
		</thead>
		<tbody>
